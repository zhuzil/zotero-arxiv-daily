...
| SEARCH_KEYWORDS|✅| str | The keywords of target arxiv papers. Use `,` to concatenate multiple keywords. |world model, MLLM, WM, Multimodal Large Language Models, Dreamer V3, DINO v2, DreamerV3, DINOv2, DINO v3, DINOv3, model based RL, MBRL, mllm agent tool use, agent tool use
